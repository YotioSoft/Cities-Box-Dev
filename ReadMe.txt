...
15.開発版の更新履歴
　Ver.1.3.1.2 r121（2018/04/26）
　　角にしか設置できないアドオンを実装
　　アドオン選択メニューで、高密度の住居/商業地区の地区設定ができない問題を修正
　　
　Ver.1.3.1.1 r120（2018/04/23）
　　アドオンセット機能を実装
　　英国風アドオンセットの一部を同梱
　　建物建設時に向きを矢印で表示
　　建物の向きをスペースで可変化
　　
　Ver.1.2.1.1 r117（2018/03/09）
　　港を仮実装（表示関連のバグあり）
　　
　Ver.1.2.0.1 r115（2018/03/01）
　　線路の橋の建設に対応
　　建築物を撤去するときにエラーS05が出る問題を修正
　　
　Ver.1.1.1.3 r113（2018/02/26）
　　道路の橋の建設に仮対応
　　
　Ver.1.1.1.2 r112（2018/02/24）
　　海・湖の作成に仮対応
　　
　Ver.1.1.1.1 r111（2018/02/23）
　　運河（川)の作成に対応
　　エラーメッセージを一部実装
　　
　Ver.1.1.0.2 r109（2018/02/20）
　　2x2のアドオンの表示関連のバグを修正
　　
　Ver.1.1.0.1 r108（2018/02/17）
　　2x2のアドオンに仮対応（表示関連のバグあり）
　　
　Ver.1.0.2.4 r106（2018/01/31）
　　夜間の電飾におけるバグを修正
　　道路など複数の画像を用いるアドオンにも夜間の電飾に対応
　　夕方・明け方の電飾の表示に対応
　　夜間の半透明色の表示方法を変更
　　
　Ver.1.0.2.3 r105（2018/01/30）
　　夜間の電飾に対応
　　設定で調節間隔と描写間隔を変更しようとするとデフォルト値に戻る問題を修正
　　住居区画の需要度が0未満になるとエラーが発生する問題を修正
　　
　Ver.1.0.2.2 r104（2018/01/27）
　　調節間隔、描写間隔の設定に対応
　　Windows版・macOS版のソースを一本化
　　
　Ver.1.0.2.1 r103（2018/01/04）
　　秋・雪のタイルに対応
